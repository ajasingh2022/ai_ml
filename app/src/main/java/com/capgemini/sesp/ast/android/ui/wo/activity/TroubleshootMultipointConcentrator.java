...
public class TroubleshootMultipointConcentrator extends AbstractWokOrderActivity {
    ...
    private static String TAG = TroubleshootMultipointConcentrator.class.getSimpleName();
    ...
    public void chooseYesNoResponse(String stepid, String responseCode) {
        try {
            if (stepid == "ChooseYesNo") {
                ...
                if (responseCode.equalsIgnoreCase("0")) {
                    activeSteps.add(fromindex, newConcentratorTechPlan);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arguments = new String[]{resources.getString(R.string.register_new_concentrator_header), "false"};
