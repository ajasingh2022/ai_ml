...
public class RepeaterInstallation extends AbstractWokOrderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arguments = new String[]{resources.getString(R.string.register_new_repeater_header), "true"};
        ...
        yesflow.add(newRepeaterTechPlan);
