...
public class EvTroubleshootMeasurePointDM extends TroubleshootMeasurePointDM {

    private static String TAG = EvTroubleshootMeasurePointDM.class.getSimpleName();
