...
public class EvSmartChargingMeterInstallationCT extends MeterInstallationCT {
    private static String TAG = EvSmartChargingMeterInstallationCT.class.getSimpleName();
