...
public class MaterialLogisticsDialogBarcodeScanner extends Activity implements OnClickListener {
...
//                finish();
            ...
            Log.e(MaterialLogisticsDialogBarcodeScanner.class.getSimpleName(), "Exception details : ", e);
        }
        return c;
    }
    ...
    PreviewCallback previewCb = new PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                writeLog("MaterialLogisticsDialogBarcodeScanner + : onPreviewFrame()", e);
            }
        }
    };
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ScanButton) {
            ...
            try {
                if (Utils.isNotEmpty(scanResult)) {
                    BarcodeListener.barcodeListener.scannedCodeItem(scanResult);
                }
            ...
            writeLog("MaterialLogisticsDialogBarcodeScanner + : onClick()", e);
        }
    }
    }
