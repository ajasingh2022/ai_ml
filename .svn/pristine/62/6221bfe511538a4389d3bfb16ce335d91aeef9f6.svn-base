...
public class ConfirmInstallationLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flow_fragment_confirm_installation_location);
    ...
    final OnClickListener backButtonClicked = new OnClickListener() {
        ...
        public void onClick(final View v) {
            ConfirmInstallationLocationActivity.this.finish();
        }
    };
