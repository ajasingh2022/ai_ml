...
public class MeterRemovalDM extends AbstractWokOrderActivity {
    ...
    private static String TAG = MeterRemovalDM.class.getSimpleName();
    ...
    public void registerCordsFragmentResponse(String stepId, String responseCode) {
        try {
            fromindex = activeSteps.indexOf(verifyInstallationCoordinates)+1;
            toindex = activeSteps.indexOf(attachPhoto);
            ...
            writeLog(TAG + "  : registerCordsFragmentResponse() ", e);
        }
    }
